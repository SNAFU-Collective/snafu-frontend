<!--<template>-->
<!--  <row style="display: flex; justify-content: center" justify="center">-->
<!--    <v-col colls="12" v-if="!isConnected" cols="1" >-->
...
<!--    <v-col cols="3" v-if="isConnected" style="margin-left: 10px;margin-top: 2.5px">-->
